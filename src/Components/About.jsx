    ...
    return (
        <>
            ...
            <div id='About' style={{ marginTop: "120px" }} >
                ...
                <div className="row "  >
                    ...
                    <center>
                        ...
                        <div className="row container w-50 mt-5 mb-5" style={{ fontWeight: "bolder", textAlign: "justify", justifyContent: "space-around" }}>
                            ...
                            <div className="col-12 col-md-4 p-5     rounded shadow  " style={{ backgroundColor: "lightblue" }}>
                    ...
                    <center>
                        ...
                        <div className="row container w-50 mt-5 mb-5" style={{ fontWeight: "bolder", textAlign: "justify", justifyContent: "space-around" }}>
                            ...
                            <div className="col-12 col-md-4 pt-5   " >
                                <h3 className='fw-bold'><FaMapLocationDot className='fs-1 mb-3 text-primary' /><br />
                                    COCHIN
                                </h3>
                            </div>
                            <div className="col-12 col-md-4 pt-5 ">
                ...
                <div className="row  mt-5 pb-5 p-3 mb-5" style={{ height: "400px", display: "flex", justifyContent: "space-evenly" }}>
                    <h3 className='mb-5'>Our Happy Clients</h3>

                    <div className="col-12 col-md-4 bg-white rounded shadow p-4 " style={{ height: "250px" }}>
                    ...
                    <div className="col-12 col-md-4 p-4 bg-white rounded shadow " style={{ height: "250px" }}>
